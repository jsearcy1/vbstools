...
%The resulting cross section at 13~TeV is 8.4~fb, which is used to normalize the expected number of signal events.
...
The dominant background to the \ssWW process comes from the $WZjj$ process where one of 
