...
This sensitivity makes VBS a possible probe of anomalous Higgs couplings~\cite{Higgs_con}. In addition new many new physics scenarios predict increases in VBS~\cite{Tmatrix,VLVLBSM,Trip_Higgs_old,Trip_higgs_new}, through extended Higgs sectors or
...
are currently in use to address the very differnt problem of paramterizing parton distribution functions~\cite{NNPDF}.
...
Training Deep NN has been the subject intensive study and a good review
